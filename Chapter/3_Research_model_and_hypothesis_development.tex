...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, below left of=mentorship, xshift=-1cm] (resources) {Resource Access};
            \node[box, below right of=mentorship, xshift=1cm] (networking) {Networking Opportunities};
            
            % Mediating variable
            \node[box, below of=mentorship, yshift=-2cm] (eo) {Entrepreneurial Orientation};
            
            % Performance variables
            \node[performance, below of=eo, yshift=-2cm] (overall) {Startup Performance};
            \node[performance, below left of=overall, xshift=-1cm] (innovation) {Innovation Performance};
            \node[performance, below right of=overall, xshift=1cm] (financial) {Financial Performance};
            \node[performance, right of=overall, xshift=2cm] (market) {Market Performance};
            ...
            % Labels
            \node[above of=mentorship, yshift=0.5cm] {\small H1, H8};
            \node[above of=resources, yshift=0.5cm] {\small H2, H9};
            \node[above of=networking, yshift=0.5cm] {\small H3, H10};
            \node[left of=eo, xshift=-0.5cm] {\small H4};
            \node[left of=innovation, xshift=-0.5cm] {\small H5};
            \node[right of=market, xshift=0.5cm] {\small H6};
            \node[right of=financial, xshift=0.5cm] {\small H7};
    ...
    \subsection{Hypothesis 1 (H1): Mentorship Quality → Entrepreneurial Orientation}
    \textbf{H1: Mentorship quality is positively related to Entrepreneurial Orientation.}

    \subsubsection{Theoretical Foundation}
    \textbf{Resource-Based View (RBV)} \cite{barney1991firm}: Access to valuable, rare, and inimitable resources creates competitive advantages. 
    \textbf{Social Learning Theory} \cite{bandura1997self}: Entrepreneurs acquire strategic behaviors through observation and interaction with experienced mentors. 
    \textbf{Human Capital Theory} \cite{becker1964human}: Knowledge and skills acquired through mentoring enhance entrepreneurial capabilities.
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, below of=resources, yshift=-3cm] (eo) {Entrepreneurial Orientation};
            
            % Resource types
            \node[resource, left of=resources, xshift=-3cm] (financial) {Financial Resources};
            \node[resource, right of=resources, xshift=3cm] (physical) {Physical Infrastructure};
            \node[resource, above of=resources, yshift=1cm] (intellectual) {Intellectual Resources};
            \node[resource, below of=resources, yshift=1cm] (human) {Human Resources};
            
            % Impact types
            \node[impact, left of=eo, xshift=-3cm] (innovative) {Innovativeness};
            \node[impact, right of=eo, xshift=3cm] (proactive) {Proactiveness};
            \node[impact, above of=eo, yshift=1cm] (risk) {Risk-taking};
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}[
            ...
            \node[box, below of=networking, yshift=-3cm] (eo) {Entrepreneurial Orientation};
            
            % Network types
            \node[network, left of=networking, xshift=-3cm] (investors) {Investor Networks};
            \node[network, right of=networking, xshift=3cm] (partners) {Industry Partners};
            \node[network, above of=networking, yshift=1cm] (experts) {Expert Networks};
            \node[network, below of=networking, yshift=1cm] (peers) {Peer Networks};
            
            % Benefits
            \node[benefit, left of=eo, xshift=-3cm] (info) {Information Flow};
            \node[benefit, right of=eo, xshift=3cm] (resources) {Resource Mobilization};
            \node[benefit, above of=eo, yshift=1cm] (validation) {Social Validation};
            
            % Arrows
            \draw[arrow] (investors) -- (networking);
            \draw[arrow] (partners) -- (networking);
            \draw[arrow] (experts) -- (networking);
            \draw[arrow] (peers) -- (networking);
